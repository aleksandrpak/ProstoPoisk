<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Message.aspx.cs" Inherits="Send" %>
...
<body style="margin: 5px 5px 5px 5px; font-family:Arial; font-size:10pt;" id="Body" runat="server">
    ...
    <table style="height:400px; border-color:#E6E2D8; border-style:solid; border-width:1px; background-color:White;"
    ...
    <asp:Label ID="lbTitle" runat="server" Text="Отправка сообщения"></asp:Label></td>
    </tr>   
    <tr> 
    ...
    <div style="margin: 15px 2px 2px 2px"><span style="color:Red">*</span> Ваше имя:</div>
    </td>
    <td align="left" valign="middle" style="width:70%">
    <div style="margin: 15px 2px 2px 2px">
    <asp:TextBox ID="tbName" runat="server" MaxLength="80" Width="60%">
    </asp:TextBox>
    ...
    <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="tbEmail"
     ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" CssClass="rfv">Введите<br />правильный<br />e-mail</asp:RegularExpressionValidator>    
    </span>
    </div>
    </td>
    </tr> 
    <tr> 
    <td align="right" valign="middle" style="width:30%">
    <div style="margin: 8px 2px 2px 2px">Ваш телефон:</div>
    </td>
    <td align="left" valign="middle" style="width:70%">
    <div style="margin: 8px 2px 2px 2px">
    <asp:TextBox ID="tbTelephone" runat="server" MaxLength="80" Width="60%">
    </asp:TextBox>    
    </div>
    </td>
    </tr>
    <tr> 
    <td align="right" valign="middle" style="width:30%">
    <div style="margin: 8px 2px 2px 2px"><span style="color:Red">*</span> Сообщение:</div>
    </td>
    <td align="left" valign="middle" style="width:70%">
    <div style="margin: 8px 2px 2px 2px">
    ...
    <span style="margin-top:7px" class="lb">
    ...
    <asp:Button ID="btnSend" runat="server" Text="Отправить сообщение" OnClick="btnSend_Click"
